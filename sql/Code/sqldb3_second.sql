...
CREATE TABLE `client` (
  ...
  `clientAddress` varchar(35) DEFAULT NULL,
  `clientBirth` date DEFAULT NULL,
  `clientHobby` varchar(20) DEFAULT NULL,
  `clientGender` varchar(5) DEFAULT NULL,
...
-- Dump completed on 2022-06-03 17:48:40
