 ...
 $(document).ready(function(){
	...
	$("#editFrm").on('submit', function(){
		...
		if((chkName == $('#userName').val()) &&			// 기존 이름과 비교
		   ...
		   (chkRoll == $('#roll').val()) &&				// 기존 권한과 비교
		   (chkstate == $('#userState').val())			// 기존 상태와 비교
		   ) {				
...
        	processData : false,
			success:function(result){
				...
				if(result == "SUCCESS"){
					alert("수정되었습니다.");
					location.href="/subPage/adminUser";
				}
			},
			error:function(){
				// 오류있을 경우 수행 되는 함수
