! function(t, e) {
    ...
    var w = {
        ...
        show(t) {
            ...
            if (t = void 0 === t ? this.state.inputText : t, !(r && !o && !n.templates.dropdownItemNoMatch || !1 === n.dropdown.enable || this.state.isLoading || this.settings.readonly)) {
                ...
                this.dropdown.fill(a), n.dropdown.highlightFirst && this.dropdown.highlightOption(this.DOM.dropdown.content.children[0]), this.state.dropdown.visible || setTimeout(this.dropdown.events.binding.bind(this)), this.state.dropdown.visible = t || !0, this.state.dropdown.query = t, this.setStateSelection(), l || setTimeout((() => {
        ...
        selectOption(t) {
            ...
            this.trigger("dropdown:select", {
                data: o,
                elm: t
            }), a && (o || n) ? (this.state.editing ? this.onEditTagDone(null, g({
                __isValid: !0
            }, this.normalizeTags([o])[0])) : this["mix" == this.settings.mode ? "addMixTags" : "addTags"]([o || this.input.raw.call(this)], i), this.DOM.input.parentNode && (setTimeout((() => {
        ...
        callbacks: {
            onFocusBlur(t) {
                ...
                if ("blur" == s) {
                    ...
                    this.postUpdate(), i.onChangeAfterBlur && this.triggerChangeEvent()
                }
                if (!o && !r)
                    if (this.state.hasFocus = "focus" == s && +new Date, this.toggleFocusClass(this.state.hasFocus), "mix" != i.mode) {
                        ...
                        "blur" == s && (this.trigger("blur", n), this.loading(!1), "select" == this.settings.mode && l && (e = ""), e && !this.state.actions.selectOption && i.addTagOnBlur && this.addTags(e, !0), "select" != this.settings.mode || e || this.removeTags()), this.DOM.input.removeAttribute("style"), this.dropdown.hide()
                ...
                if (this.trigger("keydown", {
                    ...
                    switch (t.key) {
                        ...
                        case "Backspace":
                            ...
                            var s, a, n, r = document.getSelection(),
    ...
    function M(t, e) {
        ...
        g(this, function(t) {
                    ...
                    if (a = a || {
                        ...
                        if (t.settings.isJQueryPlugin) "remove" == i && (i = "removeTag"), jQuery(t.DOM.originalInput).triggerHandler(i, [s]);
                            ...
                            try {
                                ...
                                if ((o = a.cloneData ? g({}, o) : o).tagify = this, s instanceof Object)
            ...
            dropdown: {},
            flaggedTags: {}
        }, this.value = [], this.listeners = {}, this.DOM = {}, this.build(t), T.call(this), this.getCSSVars(), this.loadOriginalValues(), this.events.customBinding.call(this), this.events.binding.call(this), t.autofocus && this.DOM.input.focus()
    }
    return M.prototype = {
        _dropdown: w,
        helpers: {
        ...
        destroy() {
            this.events.unbindGlobal.call(this), this.DOM.scope.parentNode.removeChild(this.DOM.scope), this.DOM.originalInput.tabIndex = this.DOM.originalInput_tabIndex, this.dropdown.hide(!0), clearTimeout(this.dropdownHide__bindEventsTimeout), clearInterval(this.listeners.main.originalInputValueObserverInterval)
        },
        ...
        toggleScopeValidation(t) {
            this.toggleClass(this.settings.classNames.tagInvalid, 1 != t), this.DOM.scope.title = !0 === t ? "" : t
        },
        toggleFocusClass(t) {
        ...
        editTag(t, e) {
            ...
            if (s) {
                ...
                })), s.addEventListener("input", o.onEditTagInput.bind(this, s)), s.addEventListener("keydown", (e => o.onEditTagkeydown.call(this, e, t))), e.skipValidation || (l = this.editTagToggleValidity(t)), s.originalIsValid = l, this.trigger("edit:start", {
                    tag: t,
                    index: a,
                    data: n,
                    isValid: l
        ...
        addTags(t, e, i) {
            ...
            return this.DOM.input.removeAttribute("style"), t.forEach((t => {
                ...
                if (t = Object.assign({}, r), a.transformTag.call(this, t), t.__isValid = this.hasMaxTags() || this.validateTag(t), !0 !== t.__isValid) {
                    ...
                    g(o, this.getInvalidTagAttrs(t, t.__isValid), {
                        __preInvalidData: r
                    }), t.__isValid == this.TEXTS.duplicate && this.flashTag(this.getTagElmByValue(t.value)), "select" == a.mode && this.toggleScopeValidation(t.__isValid)
                }
            ...
            })), this.appendTag(n), this.update(), t.length && e && this.input.set.call(this), a.dropdown.enabled && this.dropdown.refilter(), s
        },
        addMixTags(t) {
