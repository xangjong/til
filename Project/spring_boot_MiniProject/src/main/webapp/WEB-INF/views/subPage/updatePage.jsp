...
<link href="<c:url value='/js/image/logo.png'/> " rel="shortcut icon" type="image/x-icon">
<link
...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/buttonD.css'/>" >
<link rel="stylesheet" type="text/css" href="<c:url value='/css/writePage.css'/>" >
<style type="text/css">
</style>
</head>
<body>
							...
							<div class="row">
								<div class="col-auto me-auto"
									...
									<i class="fa-solid fa-lg fa-pen-to-square"
										style="margin-right: 10px"></i>게시물 수정
								</div>
								<div class="col-auto">
											...
											<tr>
												<td rowspan="2">
													<c:if test="${not empty note.userImg}">
														<img class="viewProfle"	src="${note.userImg }">
													</c:if>
												</td>
								...
								<div class="row viewSubWrap">
									...
									<div class="mb-3">
										<input type="email"  id="noteTitle"
											class="form-control exampleFormControlInput1" placeholder="제목을 입력해주세요"
											value="${note.noteTitle }">
									</div>
									<div>
										<input id='hashtag' name='hashtag' placeholder="해시태그를 입력해주세요"
