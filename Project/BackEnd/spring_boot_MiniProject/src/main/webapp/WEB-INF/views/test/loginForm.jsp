...
<html>
	<head>
		...
		<script src="<c:url value='/js/test/login.js'/> "></script>
			...
			<div class="loginBox">
				...
				<form class="loginForm" id="loginForm" method="post">
					<div class="input">
						<div class="inpuEventBox">
							<input type="text" id="userId" class="idInput" name="id" autocomplete="off" required>
							<label for="idInput" class="eventLabel"><span>아이디</span></label>
						</div> <!-- inpuEventBox -->
		
						<div class="inpuEventBox">
							<input type="password" id="userPw" class="pwInput" name="pwd" autocomplete="off" required>
				...
				<div class="joinPass">
					<ul>
						...
						<li><a href="<c:url value='/test/joinForm'/>" class="join">회원가입</a></li>
					</ul>
				</div> <!-- joinPass -->
			</div><!--loginBox  -->
		</section>
